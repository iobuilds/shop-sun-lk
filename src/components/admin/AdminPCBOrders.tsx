...
export default function AdminPCBOrders({ orders, onRefresh, allProfiles }: AdminPCBOrdersProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Template-based SMS helper
      const sendPCBSms = (templateKey: string, extraData?: Record<string, string>) =>
        supabase.functions.invoke("send-pcb-sms", { body: { order_id: editTarget.id, template_key: templateKey, extra_data: extraData } });
