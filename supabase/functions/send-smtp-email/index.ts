...
const LOGO_HEADER = `<div style="background:#1a1a2e;padding:20px 32px;text-align:center"><img src="${LOGO_URL}" alt="NanoCircuit" style="max-height:50px;width:auto;display:inline-block"></div>`;
